import 'package:app_ui/src/core/behaviors/behaviors.dart';
import 'package:app_ui/src/tokens/themes/themes.dart';
import 'package:dropdown_button2/dropdown_button2.dart';
import 'package:flutter/material.dart';

///
class AppDropdownFieldWidget<T> extends StatefulWidget {
  ///
  ...
  @override
  State<AppDropdownFieldWidget<T>> createState() => _AppDropdownFieldWidgetState<T>();
}

class _AppDropdownFieldWidgetState<T> extends State<AppDropdownFieldWidget<T>> {
  @override
